		    ...
		    |id croO id_integer croF 
		    	{	erreur = 1; //init
					if (doubleDeclaration($1)==1 ) //TABLEAU NON DECLARED
						{
							printf("\nErreur Sementique: Entite %s non declaree a la ligne %d.",$1,nbLigne);
...
EXP: COMP ENTIER 					{	erreur =1 ;
	...
	|COMP id
										{erreur =1 ;
													if (doubleDeclaration($2)==1 ) //non dec
														{
															printf("\nErreur Sementique: Entite %s non declaree a la ligne %d.",$2,nbLigne);
															erreur = 0;
														}
													else 
													{	
	...
	|space LOG space id						{
												...
												if (doubleDeclaration($4)==1) {
														printf("\nErreur Sementique: Entite %s non declaree a la ligne %d.",$4,nbLigne);
														erreur = 0;
												}else
												{
